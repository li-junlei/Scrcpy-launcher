...
> 最后更新：2026-01-30 11:40:00
> 项目版本：v2.6.0
> 扫描覆盖率：约 90%（核心模块全覆盖，新增功能文档完善）

## 变更记录 (Changelog)

### 2026-01-30 (增量更新 v2.6.0)
- 新增功能：应用宝搜索（替代手机应用浏览）
- 新增功能：GitHub Release 自动更新检查
- 新增命令：`search_yyb`, `download_yyb_icon`, `check_for_updates`
- 新增依赖：`scraper`, `reqwest` (json feature), `urlencoding`
- 前端：新增更新提示弹窗、设置页面"关于"区域
...
**v2.6.0 新增功能**：
- 应用宝搜索：输入应用名称搜索腾讯应用宝获取包名和图标
- 自动更新检查：启动时静默检查 GitHub Release 新版本
- 设置页面新增"关于"区域，显示版本号和手动检查更新按钮
- 更新提示弹窗：显示版本号、更新说明，支持"此版本不再提醒"
